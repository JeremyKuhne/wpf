...
namespace System.Windows
{
    ...
    public class SplashScreen
    {
        ...
        public unsafe void Show(bool autoClose, bool topMost)
        {
            ...
            if (CreateLayeredWindowFromImgBuffer(new(resourceStream.PositionPointer, (int)resourceStream.Length), topMost) && autoClose)
            {
        ...
        private unsafe HWND CreateWindow(HBITMAP hBitmap, int width, int height, bool topMost)
        {
            ...
            HDC screenContext = PInvokeCore.GetDC(HWND.Null);
            HDC memoryContext = PInvokeCore.CreateCompatibleDC(screenContext);
            HGDIOBJ oldBitmap = PInvokeCore.SelectObject(memoryContext, hBitmap);
            ...
            PInvokeCore.SelectObject(memoryContext, oldBitmap);
            PInvokeCore.ReleaseDC(HWND.Null, memoryContext);
            PInvokeCore.ReleaseDC(HWND.Null, screenContext);
        ...
        private object CloseInternal(object fadeOutArg)
        {
            ...
            if (_dt is not null || _hwnd == IntPtr.Zero)
            {
                return BooleanBoxes.TrueBox;
            }
        ...
        private void Fadeout_Tick(object unused, EventArgs args)
        {
            ...
            else
            {
                ...
                PInvoke.UpdateLayeredWindow(_hwnd, HDC.Null, null, null, HDC.Null, null, default, _blendFunction, UPDATE_LAYERED_WINDOW_FLAGS.ULW_ALPHA);
            }
        }
        ...
        private unsafe bool CreateLayeredWindowFromImgBuffer(Span<byte> buffer, bool topMost)
        {
            bool success = false;
